 ...
 *
 * Generated: 2025-12-23T04:22:42.526Z
...
export interface AttributeAttribute {
    ...
    overlap?:                     boolean;
    object_width_standard?:       ObjectStandard;
    object_height_standard?:      ObjectStandard;
    object_text_option?:          ObjectTextOption;
    object_text_position_option?: ObjectTextPositionOption;
...
export interface FootnoteShapeAttributes {
    ...
    numbering:     NumberingEnum;
    superscript:   boolean;
    prefix:        boolean;
}

export type NumberShape = "arabic";

export type NumberingEnum = "continue";

export type PagePosition = "separate";
...
export type BindingMethod = "single_page";
...
export type AlternativeFontName = string;

export type AlternativeFontType = string;
...
export type ExtendedLevelFormatString = string;
...
export type LevelFormatString = string;
...
export type DocumentFlag = string;

export type Signature = string;

export type VersionEnum = string;
...
export type LastSavedBy = string;

export type RevisionNumber = string;
